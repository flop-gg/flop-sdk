...
#ifdef CLIENT_DLL
#define CWeaponShotgun_1 C_WeaponShotgun_1
#endif

extern ConVar sk_auto_reload_time;
extern ConVar sk_plr_num_shotgun_pellets;

class CWeaponShotgun_1 : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS( CWeaponShotgun_1, CBaseHL2MPCombatWeapon );
...
//	void WeaponIdle( void );
	...
	CWeaponShotgun_1(void);

private:
	CWeaponShotgun_1( const CWeaponShotgun_1 & );
};

IMPLEMENT_NETWORKCLASS_ALIASED( WeaponShotgun_1, DT_WeaponShotgun_1 )

BEGIN_NETWORK_TABLE( CWeaponShotgun_1, DT_WeaponShotgun_1 )
#ifdef CLIENT_DLL
...
#ifdef CLIENT_DLL
BEGIN_PREDICTION_DATA( CWeaponShotgun_1 )
...
LINK_ENTITY_TO_CLASS( weapon_shotgun_1, CWeaponShotgun_1 );
PRECACHE_WEAPON_REGISTER(weapon_shotgun_1);

#ifndef CLIENT_DLL
acttable_t	CWeaponShotgun_1::m_acttable[] = 
{
...
IMPLEMENT_ACTTABLE(CWeaponShotgun_1);
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponShotgun_1::StartReload( void )
{
	if ( m_bNeedPump )
		return false;
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponShotgun_1::Reload( void )
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgun_1::FinishReload( void )
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgun_1::FillClip( void )
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgun_1::Pump( void )
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
//
//-----------------------------------------------------------------------------
void CWeaponShotgun_1::DryFire( void )
{
	WeaponSound(EMPTY);
...
//
//-----------------------------------------------------------------------------
void CWeaponShotgun_1::PrimaryAttack( void )
{
	...
	FireBulletsInfo_t info( 8, vecSrc, vecAiming, GetBulletSpread(), MAX_TRACE_LENGTH, m_iPrimaryAmmoType );
...
//-----------------------------------------------------------------------------
void CWeaponShotgun_1::ItemPostFrame( void )
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponShotgun_1::CWeaponShotgun_1( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponShotgun_1::ItemHolsterFrame( void )
{
	// Must be player held
...
//==================================================
/*
void CWeaponShotgun_1::WeaponIdle( void )
{
	//Only the player fires this way so we can cast
