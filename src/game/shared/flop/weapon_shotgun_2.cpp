...
#ifdef CLIENT_DLL
#define CWeaponShotgun_2 C_WeaponShotgun_2
#endif

extern ConVar sk_auto_reload_time;
extern ConVar sk_plr_num_shotgun_pellets;

class CWeaponShotgun_2 : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS( CWeaponShotgun_2, CBaseHL2MPCombatWeapon );
...
//	void WeaponIdle( void );
	...
	CWeaponShotgun_2(void);

private:
	CWeaponShotgun_2( const CWeaponShotgun_2 & );
};

IMPLEMENT_NETWORKCLASS_ALIASED( WeaponShotgun_2, DT_WeaponShotgun_2 )

BEGIN_NETWORK_TABLE( CWeaponShotgun_2, DT_WeaponShotgun_2 )
#ifdef CLIENT_DLL
...
#ifdef CLIENT_DLL
BEGIN_PREDICTION_DATA( CWeaponShotgun_2 )
...
LINK_ENTITY_TO_CLASS( weapon_shotgun_2, CWeaponShotgun_2 );
PRECACHE_WEAPON_REGISTER(weapon_shotgun_2);

#ifndef CLIENT_DLL
acttable_t	CWeaponShotgun_2::m_acttable[] = 
{
...
IMPLEMENT_ACTTABLE(CWeaponShotgun_2);
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponShotgun_2::StartReload( void )
{
	if ( m_bNeedPump )
		return false;
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponShotgun_2::Reload( void )
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgun_2::FinishReload( void )
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgun_2::FillClip( void )
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgun_2::Pump( void )
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
//
//-----------------------------------------------------------------------------
void CWeaponShotgun_2::DryFire( void )
{
	WeaponSound(EMPTY);
...
//
//-----------------------------------------------------------------------------
void CWeaponShotgun_2::PrimaryAttack( void )
{
...
//-----------------------------------------------------------------------------
void CWeaponShotgun_2::ItemPostFrame( void )
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponShotgun_2::CWeaponShotgun_2( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponShotgun_2::ItemHolsterFrame( void )
{
	// Must be player held
...
//==================================================
/*
void CWeaponShotgun_2::WeaponIdle( void )
{
	//Only the player fires this way so we can cast
