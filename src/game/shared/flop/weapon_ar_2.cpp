...
{
	#define MAX_VERTICAL_KICK   4.55f	// What is the max recoil angle?
	#define SLIDE_LIMIT         18		// How many shots does it take for the recoil to reach max?
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAR_2::SecondaryAttack( void )
{
